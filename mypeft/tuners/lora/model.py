...
from mypeft.import_utils import is_bnb_4bit_available, is_bnb_available
from mypeft.tuners.tuners_utils import BaseTuner, BaseTunerLayer, check_target_module_exists, onload_layer
from mypeft.utils import (
...
from mypeft.utils.merge_utils import dare_linear, dare_ties, magnitude_prune, task_arithmetic, ties
...
class LoraModel(BaseTuner):
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        from mypeft.tuners.adalora import AdaLoraLayer
